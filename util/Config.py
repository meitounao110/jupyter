...
def create_parser():
    ...
    parser.add_argument('--mean-layout', default=0, type=int, metavar='N')
    parser.add_argument('--std-layout', default=1000, type=int, metavar='N')
    ...
    parser.add_argument('--af', default=0.3, type=float, metavar='M',
                        help='af')
    parser.add_argument('--upsize', default=50, type=float, metavar='M',
                        help='upsize')
    return parser
